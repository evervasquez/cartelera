    ...
    <div class="container-fluid">
        <div class="navbar">
            <div class="navbar-header">
                ...
                <a class="navbar-brand visible-lg visible-md" href="{{url('/')}}">
                    <img src="assets/img/logo.png" alt="Jump start">
                </a>
                <!-- Show logo for small screens -->
                <a class="navbar-brand hidden-lg hidden-md hidden-xs" href="{{url('/')}}">
...
<script type="text/template" id="comentario-template">
    ...
    <label class="timeline-label">
        ...
        <% } else{%>
        <img class="photo-coment" src="assets/img/facebook/<%= fotoperfil %>" alt="pic1" width="35px" height="35px;">
        <% } %>
    </label>
